  ...
  const loaders = `<span class='loaders'><span class='loaders__dot'></span><span class='loaders__dot'></span><span class='loaders__dot'></span></span>`;
  const errorMessage = 'Hi! How can I support your work today?';
  ...
  const send = (text = '') => {
    ...
    aiMessage(loaders, true, botLoadingDelay);
  };
